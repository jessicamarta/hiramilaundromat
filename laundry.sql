...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Jul 23, 2025 at 10:39 AM
...
INSERT INTO `operasional` (`id`, `keperluan`, `status`) VALUES
(2, 'Membeli pelicin baju 3 box', 1),
(4, 'Membeli detergen 200 ml', 0);
...
(3, 'Jessica Marta', '081292900998', 'Depok Timur'),
(4, 'Jeremy', '081283820922', 'Depok Lama'),
(5, 'Jasmine ', '081292873664', 'Jamuju'),
(7, 'Laurence', '081293756453', 'Jakarta Timur');
...
(1, '2025-03-08', 3, 35000, 5, '2025-03-10', 2),
(3, '2025-03-08', 4, 21000, 3, '2025-03-11', 2),
(4, '2025-06-20', 5, 9000, 3, '2025-06-22', 2),
(6, '2025-07-15', 7, 6000, 2, '2025-07-17', 2);
...
--
ALTER TABLE `pakaian`
  MODIFY `pakaian_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
('root', '[{\"db\":\"laundry\",\"table\":\"transaksi\"},{\"db\":\"laundry\",\"table\":\"admin\"},{\"db\":\"laundry\",\"table\":\"pelanggan\"},{\"db\":\"laundry\",\"table\":\"operasional\"},{\"db\":\"laundry\",\"table\":\"pakaian\"},{\"db\":\"laundry\",\"table\":\"harga\"},{\"db\":\"data_siswa\",\"table\":\"user\"}]');
...
('laundry', 'admin', 1, 405, 171),
('laundry', 'harga', 1, 74, 164),
('laundry', 'operasional', 1, 747, 181),
('laundry', 'pakaian', 1, 401, 400),
('laundry', 'pelanggan', 1, 41, 405),
('laundry', 'transaksi', 1, 754, 357);
...
('root', '2025-07-23 08:38:00', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":346}');
