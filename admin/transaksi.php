...
<div class="container">
    <div class="panel">
        ...
        <div class="panel-body">
            <a href="transaksi_tambah.php" class="btn btn-sm btn-success pull-right">Transaksi Baru</a>
            <br/>
            <br/>
            <table class="table table-bordered table-striped">
                ...
                while($d=mysqli_fetch_array($data)){
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="transaksi_invoice.php?id=<?php echo $d['transaksi_id']; ?>" target="_blank" class="btn btn-sm btn-info">Nota</a>
